# 回归批次 pathglob-f01：pathglob 用例执行报告
...
| 2 | FAIL | test_directory_rule_requires_dir_flag_for_exact_match |
| 3 | FAIL | test_double_star_crosses_directories |
| 4 | FAIL | test_escape_in_directory_rule |
| 5 | FAIL | test_trailing_slash_is_directory_only |

## 缺陷归类

| 编号 | 缺陷描述 |
|---|---|
| 1 | 目录规则在 is_dir=False 时把自己也算命中，语义放宽 |
