...
| 2 | ERROR | test_4_repeated_logs_ratio |
| 3 | ERROR | test_5_compress_not_quadratic |
| 4 | ERROR | test_6_decompressor_chunked_feeds |
| 5 | ERROR | test_8_random_bytes_roundtrip |
| 6 | ERROR | test_all_zeros |
| 7 | ERROR | test_cross_feed_match |
| 8 | ERROR | test_incompressible_stored_as_literals |
| 9 | FAIL | test_match_token_bytes |
| 10 | ERROR | test_max_match_length |
| 11 | ERROR | test_offset_exactly_window |
| 12 | ERROR | test_varint_roundtrip |
| 13 | ERROR | test_window_level_combinations |

## 缺陷归类

| 编号 | 缺陷描述 |
|---|---|
| 1 | 匹配标签里存的长度与格式说明不符，字节级布局对不上 |
| 2 | 变长整数的字节上限被改小，长整数编解码不再往返 |
| 3 | 分块喂入时校验值没有按块累加，一次性接口却能过 |
